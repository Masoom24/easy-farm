...
const Header = () => {
    return (
        <>
            ...
            <div className='flex justify-between px-5 border drop-shadow-lg bg-cyan-400 text-white bg-gradient-to-l from-purple-400 to cyan-500'>
                <div className=''><Link to='/home'><img src={logo} alt="" className='w-48' /></Link></div>
                ...
                <div className='flex justify-center items-center'><img src={addToBasket} className='w-16 drop-shado-lg' alt="logo" /></div>
            </div>
