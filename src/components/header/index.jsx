    ...
    return (
        <>
            ...
            <div className='flex justify-between px-5 focus:outline-none text-black bg-white'>
                ...
                <div className='flex py-5 justify-between w-1/4 clear-none list-none'>
                    <div><li className='drop-shadow-lg transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-orange-500 duration-300 rounded-xl p-2'><Link to='/home'>Home</Link></li></div>
                    <div><li className='drop-shadow-lg transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-orange-500 duration-300 rounded-xl p-2'><Link to='/contactUs'>Contact us</Link></li></div>
                    <div><li className='drop-shadow-lg transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-orange-500 duration-300 rounded-xl p-2'><Link to='/aboutUs'>About us</Link></li></div>
                </div>
