...
const Footer = () => {
  return (
    ...
    <div style={divStyles} className=" mx-auto py-16 px-4 grid lg:grid-cols-1 gap-8 bg-cyan-400 text-white bg-gradient-to-l from-purple-400 to cyan-500">
      <div >
        <h1 style={{ color: "cyan" }} className="w-full text-3xl font-bold text-[#00df9a]">EasyFarm</h1>
          ...
          <div className='flex gap-[150px]'>
            ...
            <div>
              <div className='justify-center items-center mb-6 '>
                ...
                <input placeholder="Your Email here..." className='px-1 py-1 focus:outline-0 drop-shadow-lg text-white outline-none border-2 border-yellow-500 rounded-xl mx-2 bg-amber-500 hover:bg-orange-500' type="email" name="email" id="footerEmail" />
                <Button variant="contained" endIcon={<SendIcon />} style={{backgroundColor:"rgb(245 158 11)",borderRadius:"12px"}}>
                  Subscribe
                </Button>
              </div>
